  ...
  return (
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>
          Embark on a transformative educational journey with our university`s comprehensive education programs. Our
          cutting-edge curriculum is designed to empower students with the knowledge, skills, and experiences needed to
        ...
        <p>
          ...
          programs offers the perfect pathway to achieve your goals and unlock your full potential in shaping the future
          of education.
        </p>
      </div>
    </div>
